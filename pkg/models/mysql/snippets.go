...
// Insert adds a new snippet into the database.
...
func (m *SnippetModel) Latest() ([]*models.Snippet, error) {
	...
	// resultset automatically closes itself and frees-up the underlying// resultset automatically closes itself and frees-up the underlying
	// database connection.
	for rows.Next() {
